#this is the test of mean data in history
#the result is overfit
import pandas as pd
import numpy as np
...
# clf = linear_model.MultiTaskElasticNetCV(normalize = True)
...
sub.to_csv('sub6_1_Multi_Elastic_overfit.csv', index = False)
