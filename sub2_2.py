...
#采集训练数据，每200分钟采集一次，
print('getting data...')
for i in [x for x in range(10, 2100) if (x % 10 == 0) & (x != 0)]:
    #print(i)
    if (i % 144) not in range(40, 100):
        #print(i)
        ...
        if i != 10:
            ...
            X1 = np.append(wifi_mean.ix[:, i - 2 : i + 20], X1, axis = 1)
...
for k in range(0, clus_num):
    ...
    f_score[k] = score.mean() * X_t.shape[0]
